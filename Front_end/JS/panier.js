...
/* ---- si le panier contient des produits, afficher les produits ajoutés -----*/
  ...
  function creatProduct(index, id, urlImage, nom, color, price, quantity) {
    ...
    newInput.classList.add("form-control", "mb-3", "text-center");
    ...
    newButton.classList.add("btn", "btn-secondary", "w-100", "align-items-center", "mb-3");
    newButton.textContent = 'supprimer';
...
// Créer le boutton confirmer
  ...
  newButtonConfirm.classList.add("btn", "btn-success", "btn-lg", "w-50", "btn-block", "clearfix", "text-center", "mt-3", "mb-3");
